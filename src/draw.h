...
#define draw_lit_fogged_tex_flat(output, z_buffer, texture, x, y0, y1, z0, z1, start_u, start_v, end_u, end_v, prev_drawn_top, prev_drawn_bot, light_factor, face_light_level_idx, fog_col) \
    draw_lit_fogged_textured_z_buffered_blended_flat_sprite(output, z_buffer, texture, x, y0, y1, z0, z1, start_u, start_v, end_u, end_v, prev_drawn_top, prev_drawn_bot, light_factor, face_light_level_idx, fog_col, NO_ALPHA_BLEND)
...
//vertical walls
#define draw_lit_fogged_clipped_textured_wall(output, z_buffer, draw_skybox, tex_column, x, y0, y1, world_y0, world_y1, peg_type, prev_drawn_top, prev_drawn_bot, world_z, light_factor, face_light_level_idx, fog_col, repeat_tex) \
    draw_lit_fogged_textured_z_buffered_blended_sprite(output, z_buffer, draw_skybox, tex_column, x, y0, y1, world_y0, world_y1, peg_type, prev_drawn_top, prev_drawn_bot, world_z, light_factor, face_light_level_idx, fog_col, repeat_tex, NO_ALPHA_BLEND, NO_DEPTH_TEST)
